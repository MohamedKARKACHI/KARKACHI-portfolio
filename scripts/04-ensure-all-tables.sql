...
DROP POLICY IF EXISTS "Public education are viewable by everyone" ON education;
...
DROP POLICY IF EXISTS "Public soft_skills are viewable by everyone" ON soft_skills;
DROP POLICY IF EXISTS "Public certifications are viewable by everyone" ON certifications;
DROP POLICY IF EXISTS "Public personal_projects are viewable by everyone" ON personal_projects;
DROP POLICY IF EXISTS "Public other_skills are viewable by everyone" ON other_skills;
...
DROP POLICY IF EXISTS "Authenticated users can insert education" ON education;
DROP POLICY IF EXISTS "Authenticated users can update education" ON education;
DROP POLICY IF EXISTS "Authenticated users can delete education" ON education;
...
DROP POLICY IF EXISTS "Authenticated users can insert soft_skills" ON soft_skills;
DROP POLICY IF EXISTS "Authenticated users can update soft_skills" ON soft_skills;
DROP POLICY IF EXISTS "Authenticated users can delete soft_skills" ON soft_skills;
...
DROP POLICY IF EXISTS "Authenticated users can manage personal_projects" ON personal_projects;
DROP POLICY IF EXISTS "Authenticated users can update personal_projects" ON personal_projects;
DROP POLICY IF EXISTS "Authenticated users can delete personal_projects" ON personal_projects;
DROP POLICY IF EXISTS "Authenticated users can manage other_skills" ON other_skills;
DROP POLICY IF EXISTS "Authenticated users can update other_skills" ON other_skills;
DROP POLICY IF EXISTS "Authenticated users can delete other_skills" ON other_skills;
